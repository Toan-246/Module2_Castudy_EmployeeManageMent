...
//                    break;
                ...
                case 6: {
                    ...
                    if (index != -1) {
                        double salary = employeeManagement.salaryCaculator(name);
                        System.out.println("Lương của nhân viên " + name + " là: " + salary + "VND");
                        System.out.println("-------------------------------------------");
                    } else {
            ...
            do {
                ...
                switch (choiceList) {
                    ...
                    case 4: {
                        ...
                        if (partTimeSize == 0) {
                            System.out.println("Không có nhân viên làm việc part time ");
                            System.out.println("--------------------------------------------------------------");
                        } else {
                            employeeManagement.displayEmployeeList(newList);
                            System.out.println("--------------------------------------------------------------");
